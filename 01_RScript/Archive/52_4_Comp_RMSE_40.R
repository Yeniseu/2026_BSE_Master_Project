...
lasso1 <- readRDS("03_Output/lasso_pred_s1_40.rds")
...
setnames(lasso1_3, c("real", "lasso_l3", "ridge_l3", "elnet_l3", "rw_l3"),
         c("real", "LASSO", "Ridge", "ElNet", "RW"))
lasso1_labor <- readRDS("03_Output/lasso_pred_s1_labor_indicators_40.rds")
...
#ggsave("03_Output/Exercise c/Growth_Acc_Cumulative_hclc_40.png", width=7, height=4)
...
#gtsave(Sample1_Step1, filename = "03_Output/RMSE20/Sample1_Step3_40.png")
...
#gtsave(Sample1_Step3, filename = "03_Output/RMSE20/Sample1_Step3_40.png")
...
lasso2 <- readRDS("03_Output/lasso_pred_s2_40.rds")
...
setnames(lasso2_3, c("real", "lasso_l3", "ridge_l3", "elnet_l3", "rw_l3"),
         c("real", "LASSO", "Ridge", "ElNet", "RW"))
lasso2_labor <- readRDS("03_Output/lasso_pred_s2_labor_indicators_40.rds")
...
#gtsave(Sample2_Step1, filename = "03_Output/RMSE20/Sample2_Step1_40.png")
...
#gtsave(Sample2_Step3, filename = "03_Output/RMSE20/Sample2_Step3_40.png")
...
gtsave(shock_table, filename = "03_Output/RMSE40/ShockTable_Step1_40.png")
...
gtsave(shock_table, filename = "03_Output/RMSE40/ShockTable_Step3_40.png")
...
gtsave(shock_table_wei, filename = "03_Output/RMSE40/ShockTable_Step3_Grouped_40.png")
...
ggplot(plot_rmse, aes(x = Year, y = RMSE, group = Model, color = Model)) +
  ...
  theme(
    axis_40.text.x = element_text(angle = 90, hjust = 1),
    plot.title = element_text(hjust = 0.5, face = "bold"),
    plot.subtitle = element_text(hjust = 0.5),
    legend.position = "top",  legend.title = element_blank()
  )
ggsave("03_Output/RMSE40/RMSE_Chart_3_Months_40.png")
# Phillips Curve
...
frcst_comb
writeLines(latex_table, "03_Output/RMSE40/variable_groupings_40.tex")
...
gtsave(shock_table_ensemble, filename = "03_Output/RMSE40/ShockTable_Step3_Ensemble.html")
gtsave(shock_table_ensemble, filename = "03_Output/Paper/RMSE40/ShockTable_Step3_Ensemble.html")
shock_table_ensemble |> as_latex() |> cat()
writeLines(shock_table_ensemble |> as_latex(), "03_Output/RMSE40/ShockTable_Step3_Ensemble_40.tex")
...
gtsave(shock_table_wei, filename = "03_Output/RMSE40/ShockTable_Step3_Grouped_Ensemble_40.png")
gtsave(shock_table_wei, filename = "03_Output/Paper/RMSE40/ShockTable_Step3_Grouped_Ensemble_40.png")
saveRDS(shock_table_ens_wei, "03_Output/Paper/RMSE_Average/Step3_Grouped_Ensemble_40.rds")
...
ggsave("03_Output/RMSE40/RMSE_Chart_3_Months_Ensemble_40.png")
ggsave("03_Output/Paper/RMSE40/RMSE_Chart_3_Months_Ensemble_40.png")
...
(shock_table_ensemble <- all_rmse_ensemble[!is.na(Year)] |>  gt() |>
    ...
    tab_style(style = cell_text(weight = "bold"), locations = cells_column_labels()) |>
    data_color(columns = -Year, direction = "row", palette = c("dodgerblue", "white", "firebrick")))
gtsave(shock_table_ensemble, filename = "03_Output/RMSE40/ShockTable_Step1_Ensemble.html")
gtsave(shock_table_ensemble, filename = "03_Output/Paper/RMSE40/ShockTable_Step1_Ensemble.html")
shock_table_ensemble |> as_latex() |> cat()
writeLines(shock_table_ensemble |> as_latex(), "03_Output/RMSE40/ShockTable_Step1_Ensemble_40.tex")
...
gtsave(shock_table_wei, filename = "03_Output/RMSE40/ShockTable_Step1_Grouped_Ensemble_40.png")
gtsave(shock_table_wei, filename = "03_Output/Paper/RMSE40/ShockTable_Step1_Grouped_Ensemble_40.png")
saveRDS(shock_table_ens_wei, "03_Output/Paper/RMSE_Average/Step1_Grouped_Ensemble_40.rds")
...
ggsave("03_Output/RMSE40/RMSE_Chart_1_Months_Ensemble_40.png")
ggsave("03_Output/Paper/RMSE40/RMSE_Chart_1_Months_Ensemble_40.png")
...
gtsave(shock_table_fed, filename = "03_Output/Paper/RMSE40/CL_FED_Comparison_40.png")
